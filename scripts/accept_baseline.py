#!/usr/bin/env python3
"""Unified baseline acceptance entry point.
...
app = typer.Typer(name="accept-baseline", help="Run and validate the full MAS baseline.")
...
def main(
    ...
    for sample in samples:
        ...
        validate_args = [
            sys.executable,
            str(_PROJECT_ROOT / "scripts" / "validate_run.py"),
            "--run-dir", str(run_dir),
        ]
        if require_adj:
